...
We provide sample test cases below. We suggest you develop your code on your own machine, and make sure your
code passes the sample test cases, before you paste it into the box below.
"""
...
for i in range(12):
    ...
    interest = monthly_unpaid_balance * monthly_interest_rate
