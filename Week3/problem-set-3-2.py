...
lettersGuessed. This function returns a string that is comprised of letters and underscores,
...
our grader will only check that the letters and underscores are in the proper order; it will not look at spacing.
